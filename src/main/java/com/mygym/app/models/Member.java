...
public class Member {
    ...
    public Member(ObjectId _id, String memberId, String name, Long mobileNumber, String emailAddress, String membershipStartDate, String membershipEndDate, Boolean isPrivilegedMember, Integer localityPincode, String photo, String username, String password, String trainerAssigned, String addedByAdminId, Boolean isActive, Boolean isFacialRegCompleted) {
        this._id = _id;
